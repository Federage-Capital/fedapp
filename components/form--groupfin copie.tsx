...
export function FormGroupfin({ className, categorieprj, ...props }: FormGroupfinProps) {
  ...
  return (
    <form
      ...
      {...props}
    >
    <div className="inline-block text-center text-sm text-slate-500">En tant qu’initiateur, vous fixez les objectifs à atteindre pour valoriser le projet. Pour plus de détails, vous pouvez accéder au guide.</div>
