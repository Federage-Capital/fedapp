    ...
    <>
      ...
      >
        ...
        <div>
          <input
            type="submit"
            className="flex items-center px-3 py-2 transition-colors bg-white border rounded-sm rounded-r-sm cursor-pointer border-gray-lighter hover:bg-link/10 hover:border-link"
            value={t("search")}
          />
        </div>
      </form>
