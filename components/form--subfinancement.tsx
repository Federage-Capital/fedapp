...
export function FormFinancement({ className, categorieprj, response, ...props }: FormFinancementProps) {
  ...
  return (
    ...
    >
      ...
      <div className="grid gap-2">
        <label htmlFor="identification groupe" className="font-semibold text-text">
          {t("identification groupe")} <span className="text-sm text-red-500">*</span>
        </label>
