...
interface NodeGroupfinRowProps {
  node: DrupalNode,
...
export function NodeGroupfinRow({ node, ...props }: NodeGroupfinRowProps) {
  ...
  return (
    ...
    <Menu as="div" className="relative inline-block text-left">
         <div>
           <Menu.Button className="flex items-center inline-block px-3 py-1 bg-indigo-100  hover:bg-indigo-200 text-blue-700 transition-colors rounded-xl text-xs text-center font-semibold lg:py-2 bg-secondary hover:bg-white hover:text-black border-secondary">
