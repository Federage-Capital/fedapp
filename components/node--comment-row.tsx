...
export function NodeCommentRow({ node, ...props }: NodeCommentRowProps) {
  const { t } = useTranslation()
  const router = useRouter()

  async function handleDelete() {
    if (!window?.confirm(t("are-you-use-you-want-to-delete-this-comment"))) {
      return
    }
