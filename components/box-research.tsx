...
export function BoxResearch({ node, logouri, useringroup, results, status }: BoxResearchlistProps) {
        ...
        <div className="pb-4">
          <div className="bg-white rounded-lg pb-4">
            ...
            <div className="flex ">
                ...
                <div>
                  {logouri
                    ...
                    .map((itemlogo) => (
                      <div key={itemlogo.id}>
                        {itemlogo?.uri && (
                          <div className="overflow-hidden h-10 w-10 rounded-full mt-3 ml-3 ">
              ...
              <div className="ml-3 grid xs:grid-cols-1 sm:grid-rows-2 sm:grid-flow-col gap-2 pt-2">
            ...
            {node?.field_description?.value && (
              <div dangerouslySetInnerHTML={{ __html: node?.field_description?.value }} className="leading-normal pb-5 text-slate-600 text-base sm:text-base lg:text-lg px-2 ml-3" />
            )}
