			...
			<div className="pb-4 p-0">
				<div className="bg-white rounded-lg">
					...
					{node.field_description?.value && (
						<div dangerouslySetInnerHTML={{ __html: node.field_description?.value }} className="leading-normal prose ml-2 pb-5 text-slate-600 sm:text-base md:text-lg lg:text-xl px-4" />
					)}
