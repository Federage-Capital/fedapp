...
<>
	...
	{propositions?.length ? (
		...
		<div>
			...
			{propositions.filter(offre1 => !offre1.uid.id.includes(user[0].id)).map(filteredOffre1 => {
...
{filteredOffre1.uid.user_picture}
							</div>
							<div className="min-w-0 flex-1">

              <Link href={filteredOffre1.path.alias} passHref>
									<a>
										<div className="w-100">
