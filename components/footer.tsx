...
export function Footer({ }) {
  return (
    ...
    <div class="grid grid-cols-12 gap-1">
      <div className="col-span-6">  FEDERAGE SAS • SIREN n°828743369 • Paris • 2023</div>
      <div className="col-span-3">  </div>
      <div className="col-span-1">
      <a href="bonjour@federage.com" data-address="bonjour" data-domain="federage.com"
        >

      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className="align-right" xmlns="http://www.w3.org/2000/svg">
      ...
      <a href="https://twitter.com/FederageCapital" target="_blank">



      <svg width="24" height="24" viewBox="0 0 20 17" fill="none" className="align-right" xmlns="http://www.w3.org/2000/svg">
...
<a href="https://github.com/Federage-Capital" target="_blank">
