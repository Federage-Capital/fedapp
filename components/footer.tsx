...
export function Footer({ }) {
  ...
  if (status === "authenticated") {
    return (
    <>
    <footer className=" fix-bottom text-white py-10 text-base mx-auto">
...
<BottomNav />
    ...
    return (
      ...
      <a href="https://twitter.com/FederageCapital" target="_blank" rel="noreferrer" className="mx-auto inline-block float-none md:float-right">
      ...
      <a href="https://github.com/Federage-Capital" target="_blank" rel="noreferrer" className="mx-auto inline-block float-none md:float-right">
