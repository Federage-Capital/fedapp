...
const MobileServiceProjetOpratio: FunctionComponent = () => {
  return (
    <div className="relative bg-white w-full overflow-y-auto flex flex-col items-start justify-start text-left text-base text-gray-900 font-text-xs-leading-4-font-normal">
