      ...
      <div className="self-stretch overflow-y-auto flex flex-col items-start justify-start pt-0 pb-16 pr-4 pl-0 gap-[32px]">
        ...
        <div className="self-stretch flex flex-col items-center justify-start gap-[24px] text-left text-base text-darkgray-200">
          <div className="self-stretch rounded-lg bg-white overflow-hidden flex flex-col items-start justify-start border-[2px] border-solid border-gray-200">
            <div className="self-stretch rounded-t-md rounded-b-none bg-white overflow-hidden flex flex-row items-center justify-start py-[9px] px-[13px] border-b-[2px] border-solid border-gray-200">
              <div className="relative leading-[24px]">Nom d’utilisateur</div>
            </div>
            <div className="self-stretch rounded-t-none rounded-b-md bg-white overflow-hidden flex flex-row items-center justify-start py-[9px] px-[13px]">
