          ...
          <div className="self-stretch flex flex-col items-start justify-start gap-[24px]">
            ...
            <div className="self-stretch flex flex-col items-start justify-start gap-[16px] text-base">
              ...
              <div className="self-stretch rounded-lg bg-white flex flex-col p-4 items-start justify-start gap-[20px]">
                ...
                <div className="self-stretch rounded-lg bg-gray-100 shadow-[0px_1px_2px_rgba(0,_0,_0,_0.05)] overflow-hidden hidden flex-row py-2.5 px-3.5 items-center justify-between text-sm text-dimgray">
                  <div className="relative leading-[20px] font-semibold">
                    Afficher le contrat
                  </div>
                  <img
