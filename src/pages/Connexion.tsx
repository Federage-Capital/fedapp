...
const Connexion: FunctionComponent = () => {
  return (
    <div className="relative bg-gray-50 w-full h-[790px] flex flex-col py-16 px-4 box-border items-center justify-center text-center text-9xl text-black1 font-text-sm-leading-5-font-medium">
