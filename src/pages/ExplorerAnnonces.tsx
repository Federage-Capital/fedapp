...
const ExplorerAnnonces: FunctionComponent = () => {
  ...
  return (
    <div
      className="relative bg-gray-50 w-full overflow-y-auto flex flex-col items-center justify-start mix-blend-normal cursor-pointer text-center text-mini text-black2 font-text-2xl-leading-8-font-bold"
    ...
    >
      ...
      <div className="self-stretch flex flex-col items-center justify-start text-left text-3xs text-mediumblue-100">
        ...
        <div className="self-stretch overflow-y-auto flex flex-col pt-6 px-4 pb-12 items-start justify-start gap-[22px]">
          <div className="self-stretch flex flex-col items-center justify-start gap-[24px] text-9xl text-black2">
