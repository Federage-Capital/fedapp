...
const Profil: FunctionComponent = () => {
  return (
    <div className="relative bg-white w-full flex flex-col items-center justify-start text-left text-base text-gray-700 font-text-sm-leading-5-font-medium">
      ...
      <div className="self-stretch bg-mediumblue-100 flex flex-col items-start justify-start pt-[52px] px-4 pb-6 text-9xl text-white">
      ...
      <div className="self-stretch flex flex-col items-start justify-start py-6 px-4 gap-[24px] text-sm">
        ...
        <div className="self-stretch flex flex-col items-start justify-start gap-[8px]">
          ...
          <div className="self-stretch rounded-lg overflow-hidden flex flex-row items-center justify-start text-base text-gray-500 border-[2px] border-solid border-gray-200">
            <div className="rounded-tl-md rounded-tr-none rounded-br-none rounded-bl-md bg-gray-50 flex flex-row items-center justify-start py-[9px] pr-1.5 pl-3">
              <div className="relative leading-[24px]">www.</div>
            </div>
            <div className="flex-1 rounded-tl-none rounded-tr-md rounded-br-md rounded-bl-none bg-white overflow-hidden flex flex-row items-center justify-start py-[9px] pr-3 pl-1.5 text-gray-700 border-l-[2px] border-solid border-gray-200">
        ...
        <div className="self-stretch flex flex-col items-start justify-start gap-[12px] text-dimgray">
          ...
          <div className="self-stretch rounded-lg flex flex-col items-center justify-start pt-[22px] px-[26px] pb-[26px] gap-[4px] text-mediumblue-100 border-[2px] border-dashed border-gray-200">
            <img
      ...
      <div className="self-stretch flex flex-col items-center justify-start pt-0 px-4 pb-6 text-center text-white">
      ...
      <div className="self-stretch bg-white flex flex-row items-center justify-between p-5 text-center text-3xs text-gray-900 border-t-[2px] border-solid border-whitesmoke-400">
