      ...
      <div className="self-stretch flex flex-col py-6 px-4 items-start justify-start gap-[24px] text-sm">
        ...
        <div className="self-stretch flex flex-col items-start justify-start gap-[8px]">
          ...
          <div className="self-stretch rounded-lg overflow-hidden flex flex-row items-center justify-start text-base text-gray-500 border-[2px] border-solid border-gray-2001">
            ...
            <div className="flex-1 rounded-tl-none rounded-tr-md rounded-br-md rounded-bl-none bg-white overflow-hidden flex flex-row py-[9px] pr-3 pl-1.5 items-center justify-start text-gray-700 border-l-[2px] border-solid border-gray-2001">
        ...
        <div className="self-stretch flex flex-col items-start justify-start gap-[12px] text-dimgray">
          ...
          <div className="self-stretch rounded-lg flex flex-col pt-[22px] px-[26px] pb-[26px] items-center justify-start gap-[4px] text-mediumblue-100 border-[2px] border-dashed border-gray-2001">
            <img
