...
const VoirApportPublic1: FunctionComponent = () => {
  return (
    <div className="relative w-full overflow-y-auto flex flex-col items-start justify-start text-center text-3xs text-gray-900 font-text-xs-leading-4-font-normal">
      ...
      <div className="self-stretch bg-gray-50 flex flex-col items-start justify-start pt-5 px-4 pb-7 gap-[28px] z-[1] text-left text-[9.83px]">
        <div className="flex flex-row items-center justify-start gap-[11px] text-darkgray-200">
        ...
        <div className="self-stretch flex flex-col items-center justify-start gap-[18px] text-5xl">
          ...
          <div className="self-stretch rounded-lg bg-white h-[46px] overflow-hidden shrink-0 flex flex-row items-center justify-center py-3 px-5 box-border text-sm text-gray-500">
            <div className="flex flex-row items-center justify-center gap-[8px]">
              <div className="relative leading-[20.03px] font-semibold">
                Afficher plus
              </div>
              <img className="relative w-2.5 h-1.5" alt="" src="/icon9.svg" />
            </div>
          </div>
        </div>
        <div className="self-stretch rounded-lg bg-white overflow-hidden flex flex-col items-start justify-start p-4 text-lg">
...
export default VoirApportPublic1;
