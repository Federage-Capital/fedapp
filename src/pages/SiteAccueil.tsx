...
const MobileAccueil: FunctionComponent = () => {
  ...
  return (
    <div className="relative bg-gray-50 w-full overflow-y-auto flex flex-col items-center justify-center mix-blend-normal text-left text-xs text-mediumblue-200 font-text-xs-leading-4-font-medium">
