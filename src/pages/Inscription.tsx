...
const Inscription: FunctionComponent = () => {
  return (
    <div className="relative bg-gray-50 w-full overflow-y-auto flex flex-col items-center justify-start pt-6 px-0 pb-0 box-border mix-blend-normal text-left text-9xl text-black font-text-xs-leading-4-font-normal">
