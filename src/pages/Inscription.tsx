...
const Inscription: FunctionComponent = () => {
  return (
    <div className="relative bg-gray-50 w-full overflow-y-auto flex flex-col items-center justify-start pt-6 px-0 pb-0 box-border mix-blend-normal text-left text-9xl text-black font-text-sm-leading-5-font-medium">
      <div className="self-stretch flex flex-col items-center justify-start">
        ...
        <div className="self-stretch overflow-y-auto flex flex-col items-start justify-start pt-6 px-4 pb-12 gap-[32px]">
          ...
          <div className="self-stretch relative h-[142px] text-base text-gray-500">
            <div className="absolute h-[50.7%] w-full top-[0%] right-[0%] bottom-[49.3%] left-[0%] flex flex-row items-start justify-start gap-[12px]">
              <div className="rounded-xl bg-mediumblue-100 w-11 h-6 overflow-hidden shrink-0 flex flex-row items-center justify-end p-0.5 box-border">
            ...
            <div className="absolute h-[35.21%] w-full top-[64.79%] right-[0%] bottom-[0%] left-[0%] rounded-lg bg-mediumblue-100 shadow-[0px_1px_2px_rgba(0,_0,_0,_0.05)] overflow-hidden flex flex-row items-center justify-center py-[13px] px-[25px] box-border text-center text-white">
              <div className="flex-1 relative leading-[24px] font-medium">
                Créer un compte
              </div>
            </div>
