...
const MobileServiceProjet2: FunctionComponent = () => {
  ...
  const onCrerProjet3ContainerClick = useCallback(() => {
    navigate("/-crerprojetpublic3");
  }, [navigate]);

  return (
    <div
      className="relative w-full h-[844px] overflow-y-auto flex flex-col items-start justify-start cursor-pointer text-left text-base text-dimgray font-text-xs-leading-4-font-normal"
      onClick={onCrerProjet3ContainerClick}
    >
      ...
      <div className="self-stretch bg-gray-50 flex flex-col items-center justify-start py-6 px-4 gap-[48px]">
        <div className="self-stretch flex flex-col items-center justify-start">
          <div className="self-stretch flex flex-col items-start justify-start gap-[12px]">
            ...
            <div className="self-stretch rounded-lg bg-white flex flex-col items-start justify-start p-4 gap-[20px] text-3xs">
              ...
              <div className="self-stretch bg-white flex flex-col items-start justify-center gap-[8px] text-base text-mediumblue-100">
                ...
                <div className="self-stretch relative leading-[20px] font-semibold text-dimgray">{`40 000€ • 19 septembre 2023 `}</div>
                <div className="self-stretch rounded-lg flex flex-col items-start justify-start text-gray-900">
                  <div className="self-stretch flex flex-row items-center justify-start gap-[10px]">
                    <img
                      className="rounded-sm w-7 h-7 object-cover"
                      alt=""
                      src="/avatar212@2x.png"
                    />
              ...
              <div className="self-stretch rounded-lg bg-gray-100 shadow-[0px_1px_2px_rgba(0,_0,_0,_0.05)] overflow-hidden flex flex-row items-center justify-center py-2.5 px-[18px] text-center text-sm">
