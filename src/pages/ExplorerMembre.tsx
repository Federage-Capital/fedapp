...
const MobileExplorerMembre: FunctionComponent = () => {
  return (
    <div className="relative w-full flex flex-col items-start justify-start text-left text-base text-gray-700 font-text-xs-leading-4-font-normal">
      ...
      <div className="self-stretch bg-gray-50 flex flex-row pt-8 px-4 pb-12 items-start justify-start text-center text-[11.28px] text-dimgray">
...
export default MobileExplorerMembre;
