  ...
  return (
    <div className="relative bg-gray-50 w-full overflow-y-auto flex flex-col items-center justify-start mix-blend-normal text-center text-mini text-black font-text-xs-leading-4-font-normal">
      ...
      <div className="self-stretch flex flex-col items-center justify-start text-xl text-gray-900">
          ...
          <div className="self-stretch flex flex-col items-center justify-start gap-[24px] text-left text-9xl text-black">
            ...
            <div className="self-stretch flex flex-row items-center justify-start py-0 pr-0 pl-1.5 gap-[28px] text-center text-[11.28px] text-dimgray">
              ...
              <div className="rounded-lg bg-white flex flex-col items-center justify-center py-1.5 px-[15px] text-mediumblue-200">
                <b className="relative leading-[18.8px]">Membres</b>
              </div>
              <b className="relative leading-[18.8px] inline-block w-[53px] shrink-0" />
            </div>
          </div>
              ...
              <div className="self-stretch flex flex-col items-start justify-start gap-[20px] text-left text-base text-gray-500">
                ...
                <div className="w-[197px] flex flex-row items-center justify-between text-xs text-dimgray">
                  <div className="flex flex-row items-center justify-start">
                    <div className="flex flex-row items-center justify-start py-0 px-0.5 gap-[6px]">
                      <img
                        className="relative w-[18px] h-[18px] overflow-hidden shrink-0"
                        alt=""
          ...
          <div className="self-stretch rounded-lg bg-white flex flex-col items-start justify-start p-4">
            <div className="self-stretch flex flex-col items-start justify-start gap-[8px]">
              <div className="self-stretch flex flex-row items-start justify-center gap-[12px]">
                ...
                <div className="flex-1 h-[53px] flex flex-col items-start justify-start">
                  <div className="flex flex-row items-center justify-center gap-[2px]">
                    <b className="flex-1 relative leading-[32px]">321founded</b>
                    <div className="flex flex-row items-center justify-center py-0 px-0.5">
                      <img
                        className="relative w-[18px] h-[18px] overflow-hidden shrink-0"
                        alt=""
              ...
              <div className="self-stretch flex flex-col items-start justify-start gap-[20px] text-left text-base text-gray-500">
                <div className="self-stretch flex flex-row items-start justify-start">
                  <div className="flex-1 relative leading-[20px] font-medium">
                    Premier studio de création d’entreprises audacieuses en
          ...
          <div className="self-stretch rounded-lg bg-white flex flex-col items-start justify-start p-4">
            <div className="self-stretch flex flex-col items-start justify-start gap-[8px]">
              ...
              <div className="self-stretch flex flex-col items-start justify-start gap-[20px] text-left text-base text-gray-500">
                <div className="self-stretch flex flex-row items-start justify-start">
                  <div className="flex-1 relative leading-[20px] font-medium">
                    Association développant une base de données libre et ouverte
          ...
          <div className="self-stretch rounded-lg bg-white flex flex-col items-start justify-start p-4">
            <div className="self-stretch flex flex-col items-start justify-start gap-[8px]">
              <div className="self-stretch flex flex-row items-start justify-center gap-[12px]">
                ...
                <div className="flex-1 h-[53px] flex flex-col items-start justify-start">
                  <div className="flex flex-row items-center justify-center gap-[2px]">
                    <b className="flex-1 relative leading-[32px]">CoopCycle</b>
                    <div className="flex flex-row items-center justify-center py-0 px-0.5">
                      <img
                        className="relative w-[18px] h-[18px] overflow-hidden shrink-0"
                        alt=""
              ...
              <div className="self-stretch flex flex-col items-start justify-start gap-[20px] text-left text-base text-gray-500">
                <div className="self-stretch flex flex-row items-start justify-start">
                  <div className="flex-1 relative leading-[20px] font-medium">
                    Fédération de coopératives de livraison à vélo, gouvernée
        ...
        <div className="self-stretch bg-white flex flex-col items-center justify-start text-base text-white">
...
export default ExplorerMembres;
