        ...
        <div className="self-stretch flex flex-col items-center justify-start">
          <div className="self-stretch flex flex-col items-start justify-start gap-[12px]">
            ...
            <div className="self-stretch rounded-lg bg-white flex flex-col p-4 items-start justify-start gap-[20px] text-3xs">
              ...
              <div className="bg-white w-[326px] flex flex-col items-start justify-center gap-[8px] text-base">
                ...
                <div className="relative w-[168px] h-5">
                  <div className="absolute top-[0px] left-[0px] w-[168px] h-5">
                    <div className="absolute top-[0px] left-[0px] leading-[20px] font-semibold">{`3 000€ • 19 mai 2023 `}</div>
                  </div>
                </div>
              ...
              <div className="rounded-lg bg-whitesmoke-200 shadow-[0px_1px_2px_rgba(0,_0,_0,_0.05)] w-[326px] overflow-hidden flex flex-row py-2.5 px-[18px] box-border items-center justify-center text-center text-sm">
                <div className="flex-1 relative leading-[20px] font-semibold">
                  Modifier
                </div>
              </div>
