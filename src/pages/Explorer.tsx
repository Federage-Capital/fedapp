...
const Explorer: FunctionComponent = () => {
  return (
    <div className="relative bg-whitesmoke-100 w-full overflow-y-auto flex flex-col pt-6 px-0 pb-0 box-border items-center justify-start mix-blend-normal text-left text-base text-gray-900 font-text-xs-leading-4-font-medium">
