...
const VoirApportx: FunctionComponent = () => {
  return (
    <div className="relative w-full overflow-y-auto flex flex-col items-start justify-start text-center text-3xs text-gray-900 font-text-xs-leading-4-font-normal">
      ...
      <div className="self-stretch bg-gray-50 flex flex-col items-start justify-start pt-5 px-4 pb-7 gap-[28px] z-[2] text-left text-[9.83px] text-darkgray-200">
        ...
        <div className="self-stretch flex flex-col items-center justify-start gap-[18px] text-5xl text-gray-500">
          <div className="self-stretch flex flex-col items-start justify-center gap-[19px]">
            ...
            <div className="self-stretch relative text-lg leading-[24px] font-medium">{`Repenser et modifier l'interface utilisateur, les fonctionnalités et les interactions de l'application pour la rendre plus intuitive, efficace et ergonomique auprès du grand public. `}</div>
          </div>
          <div className="self-stretch rounded-lg bg-white h-[46px] overflow-hidden shrink-0 flex flex-row items-center justify-center py-3 px-5 box-border text-sm text-gray-700">
            <div className="flex flex-row items-center justify-center gap-[8px]">
              ...
              <img className="relative w-2.5 h-1.5" alt="" src="/icon11.svg" />
            </div>
          </div>
        </div>
      </div>
      <div className="self-stretch bg-gray-50 flex flex-col items-start justify-start pt-0 px-4 pb-6 gap-[20px] z-[3] text-left text-lg">
        <div className="self-stretch rounded-lg bg-white flex flex-col items-start justify-start py-5 px-0 gap-[12px] text-sm border-[1px] border-solid border-whitesmoke-400">
          <div className="flex flex-row items-center justify-start py-0 px-4">
            <img
          ...
          <div className="self-stretch flex flex-col items-start justify-start py-0 px-4 gap-[22px]">
              ...
              <div className="self-stretch flex flex-col items-start justify-start gap-[10px]">
                ...
                <div className="self-stretch flex flex-row items-start justify-between text-base text-slategray">
                  <div className="flex-1 relative leading-[24px] font-medium">
                    Mise en œuvre dans le code : chaînes de caractères traduites
                    dans le code de l’application en utilisant des mécanismes
                    web.
                  </div>
                </div>
              </div>
              <div className="self-stretch relative bg-whitesmoke-400 h-px" />
              <div className="self-stretch flex flex-col items-start justify-start gap-[10px]">
                <div className="relative leading-[20px] font-semibold">
                  Prix et date de livraison
                </div>
                <div className="self-stretch flex flex-row items-start justify-between text-base text-dimgray">
                  <div className="flex-1 relative leading-[24px]">
                    <span className="font-medium">{`400,00€ `}</span>
                    <b>•</b>
                    <span className="font-medium"> 30/09/2023</span>
                  </div>
                </div>
              </div>
              <div className="self-stretch relative bg-whitesmoke-400 h-px" />
            </div>
            <div className="self-stretch rounded-lg bg-gray-900 shadow-[0px_1px_2px_rgba(0,_0,_0,_0.05)] h-[46px] overflow-hidden shrink-0 flex flex-row items-center justify-center py-[9px] px-[17px] box-border text-base text-white">
              <div className="relative leading-[20px] font-semibold">
                Modifier
              </div>
            </div>
        ...
        <div className="self-stretch rounded-lg bg-gray-100 flex flex-col items-center justify-start py-5 px-4 gap-[14px] text-base text-black border-[1px] border-solid border-gainsboro-100">
          ...
          <div className="self-stretch flex flex-col items-center justify-start gap-[10px] text-gray-700">
            <div className="self-stretch relative h-[58px]">
              <div className="absolute top-[0px] left-[0px] rounded-lg bg-white w-[326px] h-[58px]" />
              <div className="absolute top-[17px] left-[20.74px] w-[284.53px] flex flex-row items-center justify-between">
