...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/-principal-21" element={<Principal2 />} />
      <Route path="/-principal-1" element={<Principal1 />} />
      ...
      <Route path="/-principal-2" element={<Principal3 />} />
      <Route path="/-principal-22" element={<Principal21 />} />
