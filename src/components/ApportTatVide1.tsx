...
const ApportTatVide1: FunctionComponent = () => {
  return (
    <div className="self-stretch rounded-lg bg-white flex flex-col py-[25px] px-[26px] items-center justify-start gap-[20px] text-center text-lg text-gray-900 font-text-sm-leading-5-font-normal border-[2px] border-solid border-gray-2001">
      <img
