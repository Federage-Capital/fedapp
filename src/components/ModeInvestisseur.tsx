...
const ModeInvestisseur: FunctionComponent = () => {
  return (
    <div className="relative rounded-lg bg-gainsboro box-border w-[346px] flex flex-row py-[15px] px-4 items-start justify-between text-left text-base text-gray-500 font-text-xs-leading-4-font-medium border-[2px] border-solid border-darkgray-100 sm:shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)]">
