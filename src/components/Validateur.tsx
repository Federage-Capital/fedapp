...
const Validateur: FunctionComponent = () => {
  return (
    <div className="rounded-8xs box-border w-[356px] h-[156px] overflow-hidden text-left text-base text-mediumblue-100 font-text-sm-leading-5-font-normal border-[1px] border-dashed border-blueviolet">
      ...
      <div className="absolute top-[20px] left-[20px] rounded-lg bg-white box-border w-[316px] h-[50px] flex flex-col py-[15px] px-[17px] items-start justify-start text-dimgray border-[2px] border-solid border-gray-2001">
        <div className="self-stretch flex flex-row items-center justify-between">
          <div className="relative leading-[20px] font-semibold">
            Ces informations sont exactes
          </div>
