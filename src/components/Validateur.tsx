...
const Validateur: FunctionComponent = () => {
  return (
    <div className="rounded-8xs box-border w-[356px] h-[156px] overflow-hidden text-left text-base text-mediumblue-100 font-text-sm-leading-5-font-medium border-[1px] border-dashed border-blueviolet">
