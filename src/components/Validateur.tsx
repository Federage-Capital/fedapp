...
const Validateur: FunctionComponent = () => {
  return (
    <div className="relative rounded-8xs box-border w-[356px] h-[156px] overflow-hidden text-left text-base text-mediumblue-100 font-text-xs-leading-4-font-normal border-[1px] border-dashed border-blueviolet">
