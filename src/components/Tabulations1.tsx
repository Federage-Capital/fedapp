...
const Tabulations: FunctionComponent = () => {
  return (
    <div className="rounded-8xs box-border w-[386px] h-[262.29px] overflow-hidden text-left text-xs text-gray-500 font-text-2xl-leading-8-font-bold border-[1px] border-dashed border-blueviolet">
