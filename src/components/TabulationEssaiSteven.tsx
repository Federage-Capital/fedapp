...
const TabulationEssaiSteven: FunctionComponent = () => {
  return (
    <div className="relative w-[238.67px] flex flex-row items-center justify-start gap-[28px] text-center text-[11.28px] text-dimgray font-text-sm-leading-5-font-medium">
