...
const ApportModifications: FunctionComponent = () => {
  return (
    <div className="relative rounded-lg bg-white box-border w-[346px] overflow-hidden flex flex-col p-[15px] items-start justify-start text-left text-xl text-gray-900 font-text-xs-leading-4-font-normal border-[2px] border-solid border-gray-200">
