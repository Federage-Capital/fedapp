...
const ApportModifications: FunctionComponent = () => {
  return (
    <div className="rounded-lg bg-white box-border w-[346px] overflow-hidden flex flex-col p-[15px] items-start justify-start text-left text-xl text-gray-900 font-text-sm-leading-5-font-normal border-[2px] border-solid border-gray-2001">
