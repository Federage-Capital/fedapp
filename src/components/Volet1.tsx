...
const Volet1: FunctionComponent = () => {
  return (
    <div className="relative rounded-8xs box-border w-[366.5px] h-[91px] overflow-hidden text-left text-sm text-mediumblue-100 font-text-2xl-leading-8-font-bold border-[1px] border-dashed border-blueviolet">
      ...
      <div className="absolute top-[50px] left-[20.5px] w-[326px] flex flex-row items-center justify-start gap-[8px]">
        ...
        <img className="relative w-2.5 h-1.5" alt="" src="/icon1111.svg" />
      </div>
    </div>
  );
};
