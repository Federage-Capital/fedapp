      ...
      {user[0].display_name}<br/>
        ...
        Contrats
            ...
            <div className="relative flex flex-col min-w-0 break-words w-full mb-6 ">
              ...
              <BoxMescomptes groupes={groupe} allfins={allfinancements} sousgroupes={messousgroupes} userid={user[0].id} ttssgroupes={sousgroupes} parente={parentedegroupe} financementssg={financementsssgroupes} membres={memberships} user={user} />
